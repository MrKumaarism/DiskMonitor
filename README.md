...
![Release](https://img.shields.io/badge/Version-1.0.4-green)
...
|---|---|---|---|
| **🚀 Portable (Recommended)** | **[DiskMonitor.exe](https://github.com/MrKumaarism/DiskMonitor/raw/main/Portable/DiskMonitor.exe)**<br>*(or **[ZIP](https://github.com/MrKumaarism/DiskMonitor/raw/main/Portable/DiskMonitor-Portable-v1.0.4.zip)**)* | **~52 KB**<br>*(~30 KB zip)* | **Zero installation required.** Just download, place anywhere, and run. Supports **"Start with Windows"** via right-click! |
| **📦 Setup Wizard** | **[DiskMonitor-Setup-v1.04.exe](https://github.com/MrKumaarism/DiskMonitor/raw/main/Installer/DiskMonitor-Setup-v1.04.exe)** | **~2.1 MB** | **Standard Windows installer.** Installs to your user profile, creates Start Menu and Startup shortcuts, and includes an uninstaller in Windows Settings. |
...
- **Installer Version**: Download and run `DiskMonitor-Setup-v1.04.exe` to follow the setup wizard.
